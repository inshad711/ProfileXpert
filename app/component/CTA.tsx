                ...
                <div className="w-full  bg-gray-100 border border-gray-200 px-8 lg:px-8 rounded-3xl">
                    <div className="grid lg:grid-cols-5 relative items-center">
                        ...
                        <div data-aos="fade-up"
                            className="order-2 lg:order-none lg:col-span-2 w-full pb-2 lg:py-2 text-center lg:text-left">
                            <h2 className="text-slate-900 capitalize text-2xl md:text-4xl font-gotu leading-tight">
                                Unlock a Special Deal, Available in the App
                            </h2>
                            <p className="capitalize text-lg leading-relaxed mt-4">
                                Your Business Deserve to be Remembered. Create Your Free Profile Today!
                            </p>
                            <div className="flex flex-row justify-center sm:justify-start pb-8 md:pb-0 gap-x-4 mt-6">
                                <a
                                    target="_blank"
